    ...
    <main class="container admin" id="content">
        <form class="narrow" action="" method="post">
            <div class="form-group">
                ...
                <input type="text" name="etiqueta" maxlength="6" size="8" value="<?php echo $etiqueta; ?>" class="form-control" oninput="this.value = this.value.toUpperCase()"/>
            </div>
            <div class="form-group">
                <label for="name">Extension: </label>
                <input type="text" name="extension" maxlength="7" size="8" value="<?php echo $extension; ?>" class="form-control" oninput="this.value = this.value.toUpperCase()"/>
            </div>
            <div class="form-group">
                <label for="name">Ubicacion TF: </label>
                <input type="text" name="ubicacion" maxlength="20" size="10" value="<?php echo $ubicacion; ?>" class="form-control" oninput="this.value = this.value.toUpperCase()"/>
            </div>
            <div class="form-group">
                <label for="name">NºSerie: <label>
                <input type="text" name="numserie" maxlength="20" size="10" value="<?php echo $numserie; ?>" class="form-control" oninput="this.value = this.value.toUpperCase()"/>
            </div>
            <div class="form-group">
...
// guardamos los datos en la base de datos
        ...
        header("Location: save_phone.php");
    }
